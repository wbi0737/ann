...
/**
  ...
  /**
   * @ORM\OneToMany(targetEntity="Wbi\ForumBundle\Entity\Posts", mappedBy="domain")
   */
  private $posts; // Ici underdomains prend un « s », car un domain a plusieurs underdomains !

...
use Wbi\ForumBundle\Entity\Type;
use Wbi\ForumBundle\Form\TypeType;
...
class TypeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('WbiForumBundle:Type')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('WbiForumBundle:Type')->find($id);
     ...
     * @Method("POST")
     * @Template("WbiForumBundle:Type:new.html.twig")
     */
     ...
     * @Method("POST")
     * @Template("WbiForumBundle:Type:edit.html.twig")
     */

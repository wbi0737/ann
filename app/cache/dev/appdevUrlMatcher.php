...
class appdevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // get_underdomain
        if ($pathinfo === '/posts/get-underdomain') {
            return array (  '_controller' => 'Wbi\\ForumBundle\\Controller\\PostsController::getUnderDomainAction',  '_route' => 'get_underdomain',);
        }

        // get_type
        if ($pathinfo === '/posts/get-type') {
            return array (  '_controller' => 'Wbi\\ForumBundle\\Controller\\PostsController::getTypeAction',  '_route' => 'get_type',);
        }
        ...
        if (rtrim($pathinfo, '/') === '/type') {
            ...
            return array (  '_controller' => 'Wbi\\ForumBundle\\Controller\\TypeController::indexAction',  '_route' => 'type',);
        }

        // type_show
        if (0 === strpos($pathinfo, '/type') && preg_match('#^/type/(?<id>[^/]+)/show$#s', $pathinfo, $matches)) {
            return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Wbi\\ForumBundle\\Controller\\TypeController::showAction',)), array('_route' => 'type_show'));
        }

        // type_new
        if ($pathinfo === '/type/new') {
            return array (  '_controller' => 'Wbi\\ForumBundle\\Controller\\TypeController::newAction',  '_route' => 'type_new',);
        }
        ...
        if ($pathinfo === '/type/create') {
            ...
            return array (  '_controller' => 'Wbi\\ForumBundle\\Controller\\TypeController::createAction',  '_route' => 'type_create',);
        }
        not_type_create:

        // type_edit
        if (0 === strpos($pathinfo, '/type') && preg_match('#^/type/(?<id>[^/]+)/edit$#s', $pathinfo, $matches)) {
            return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Wbi\\ForumBundle\\Controller\\TypeController::editAction',)), array('_route' => 'type_edit'));
        }

        // type_update
        if (0 === strpos($pathinfo, '/type') && preg_match('#^/type/(?<id>[^/]+)/update$#s', $pathinfo, $matches)) {
            if ($this->context->getMethod() != 'POST') {
                $allow[] = 'POST';
                goto not_type_update;
            }

            return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Wbi\\ForumBundle\\Controller\\TypeController::updateAction',)), array('_route' => 'type_update'));
        }
        not_type_update:

        // type_delete
        if (0 === strpos($pathinfo, '/type') && preg_match('#^/type/(?<id>[^/]+)/delete$#s', $pathinfo, $matches)) {
            if ($this->context->getMethod() != 'POST') {
                $allow[] = 'POST';
                goto not_type_delete;
            }

            return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Wbi\\ForumBundle\\Controller\\TypeController::deleteAction',)), array('_route' => 'type_delete'));
        }
        not_type_delete:

 ...
 */
class Underdomain extends \Wbi\ForumBundle\Entity\Underdomain implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'label', 'domain', 'types', 'posts');
    }
